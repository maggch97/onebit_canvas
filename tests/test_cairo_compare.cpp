...
int main( int argc, char** argv )
{
    try
    {
        ...
        compare_case( "fractional_clip_right", 57, 31,
                      { { { 12.35, 4.2 }, { 63.8, 7.55 }, { 64.1, 19.9 }, { 18.2, 18.7 } } } );

        compare_case( "fractional_clip_box", 57, 31,
                      { { { -5.2, 3.3 }, { 28.8, -4.1 }, { 61.7, 5.4 }, { 58.2, 34.6 }, { -3.7, 26.2 } } } );
